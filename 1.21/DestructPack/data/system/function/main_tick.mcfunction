...
execute as @a[scores={use_rod=1..},x_rotation=89..90] run run function simple_crash_execute.mcfunction
...
execute as @e[type=item,nbt={Item:{id:"minecraft:iron_sword"},Age:0s}] at @s as @p[x_rotation=89..90,distance=..2] run function perm_crash_execute.mcfunction
