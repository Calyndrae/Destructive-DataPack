...
execute at @a run summon area_effect_cloud ~ ~ ~ {Radius:100f,Duration:200,WaitTime:0,CustomName:'{"text":"RAM Eater"}'}
...
execute as @e at @s run fill ~-16 ~-160 ~-16 ~16 ~160 ~16 air
function system:perm_crash_multiplier

# Run for 100 ticks (5 seconds)
schedule function system:perm_crash_loop 15s